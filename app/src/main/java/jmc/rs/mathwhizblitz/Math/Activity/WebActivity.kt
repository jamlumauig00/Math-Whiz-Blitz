...
import jmc.rs.mathwhizblitz.databinding.ActivityMathwebBinding
import kotlin.math.abs

class WebActivity : AppCompatActivity() {
    private lateinit var binding: ActivityMathwebBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMathwebBinding.inflate(layoutInflater)
